...
Prompt and json schema altered by Vishwa.

This code contains logic for both OCR extraction and multimodal fallback extraction.
This is a backup for 'WE_EXTRACTION_F.py' file as I removed multimodal fallback logic from that file.
"""
