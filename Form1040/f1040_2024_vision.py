...
def extract_1040_2024_details_vision(image_paths: list, output_json_path: str):
...
Your core task is to take unstructured OCR (Optical Character Recognition) text from an IRS Form 1040 2024 and transform it into a perfectly structured, schema-compliant JSON object.
...

{
  ...
  "standard_deduction": {
    "someone_can_claim": {
      "you_as_dependent": false,
      "spouse_as_dependent": false,
      "spouse_itemizes": false
    },
    "age_blindness": {
      "you": {
        "born_before_january2_1960": false,
        "blind": false
      },
      "spouse": {
        "born_before_january2_1960": false,
  ...
  "income": {
    ...
    "line_7_capital_gain_loss": {
      "ScheduleD_not_required": false,
      "capital_gain_loss_amount": null
    },
  ...
  "payments": {
    ...
    "line_26_estimated_tax_payments": null,

    "line_27a_eic": null,

    "line_28a_additional_child_tax_credit": null,
...
def extraction_metrics(parsed_json, accuracy_score=None):
    ...
    # fields data which will be used as a report for things like hitl trigger
    data["processing_report"] = report_payload

    # fields data which will be used for things like user validation
...
if __name__ == "__main__":
    ...
    target_images = [
        "Form1040_images/output_images_2024/page_1.png",
        "Form1040_images/output_images_2024/page_2.png"
    ]
    
    output_json_file = "json/f1040_2024_output.json"
    
    logger.info("Starting 1040 2024 Form Extraction with Bedrock Vision LLM")
    extract_1040_2024_details_vision(target_images, output_json_file)
