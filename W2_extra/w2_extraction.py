...
8. Return ONLY valid JSON — no markdown, no explanation, no comments.
"""
...
def pretty_print_summary(w2_data: dict) -> None:
    ...
    print(f"  Federal Tax     : ${wages.get('federal_income_tax_withheld', 0):,.2f}")
...
if __name__ == "__main__":
    ...
    try:
        ...
        save_results(result, output_path="w2_extracted.json")
